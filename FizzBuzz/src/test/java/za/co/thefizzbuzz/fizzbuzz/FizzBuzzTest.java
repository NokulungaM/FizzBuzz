...
public class FizzBuzzTest {
    ...
    public void notDivisibleBy3or5() {
        za.co.thefizzbuzz.fizzbuzz.FizzBuzz fizzBuzz = new za.co.thefizzbuzz.fizzbuzz.FizzBuzz();
    ...
    @Test void divisibleBy3And5() {
        za.co.thefizzbuzz.fizzbuzz.FizzBuzz fizzBuzz = new za.co.thefizzbuzz.fizzbuzz.FizzBuzz();
        String result = fizzBuzz.checkNumber(0);
    ...
    public void generateUpTo15() {
        za.co.thefizzbuzz.fizzbuzz.FizzBuzz fizzBuzz = new FizzBuzz();
